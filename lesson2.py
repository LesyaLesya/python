...
for key in days:
    if data_split[0] == key:
        data_split[0] = days[key]

for key in months:
    if data_split[1] == key:
        data_split[1] = months[key]

print(f'{data_split[0]} {data_split[1]} {data_split[2]} года')
...
random_numbers = []
n = int(input('Введите количетсво случаных чисел'))
